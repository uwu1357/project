...
from ..utils_blocks import DFBlock, AttSubBlock, TCUB
...
class Decoder(nn.Module):
    def __init__(
        ...
        self.self_att = AttSubBlock(timbre_emb_size, 8)
        self.cross_att = AttSubBlock(timbre_emb_size, 8)
        self.self_att_2 = AttSubBlock(timbre_emb_size , 8)
        self.cross_att_2 = AttSubBlock(timbre_emb_size , 8)
    ...
    def forward(self, f0, loudness, timbre_emb):
        ...
        out_cross_att = self.cross_att(out_self_att, timbre_emb)
        out_self_att_2 = self.self_att_2(out_cross_att, out_cross_att)
        out_cross_att_2 = self.cross_att_2(out_self_att_2, out_self_att_2)

        cat_final = torch.cat([out_f0_mlp, out_l_mlp, out_cross_att_2], dim=-1)
